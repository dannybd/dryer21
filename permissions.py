...
Process("Collector", "/dryer21/code/collector.py")
...
grant("Collector", "/dryer21/data/collector_master_private_key")
grant("Collector", "/dryer21/data/mixin_address")
...
grant_rpc("Collector", "SellerDB")
grant_rpc("Collector", "Check")
